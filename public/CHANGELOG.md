...
- **A partly typed activity is flagged as soon as you leave its estimate cells.** Typing Min 5 into a new activity and clicking elsewhere on the page saves 5 / 1 / 1 (with the Min/Max heuristic off, the default), and the activity is now named in the validation summary, with its Min cell red and Run refused. Until now, for such an activity, the summary and the red cell waited until you had visited all three estimates, and only the line under the Run Simulation button said why Run was refused.
