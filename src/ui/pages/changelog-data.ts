    ...
    sections: [
      {
        title: "Changed",
        items: [
          "Five confirmation boxes now match the rest of the app. Deleting an activity, deleting several selected activities at once, deleting a scenario, deleting a project whose stored data could not be read, and resetting all preferences to their defaults each used to raise the browser's own grey \"Are you sure?\" box. All five now ask in a window that matches the app, in both light and dark themes, with a red Delete button and wording that says what will actually happen — including, where it is true, that Undo will bring it back.",
