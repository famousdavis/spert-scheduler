...
export const CHANGELOG: ChangelogEntry[] = [
    ...
    sections: [
      {
        title: "Changed",
        items: [
          "Licence text only. Nothing in the app changed — it behaves identically to 0.67.18.",
    ...
    sections: [
      {
        title: "Internal",
        items: [
          "Internal only. Nothing in the app changed — it behaves identically to 0.67.17.",
          ...
          "No rule that is enforced anywhere changed. The rules that actually govern the database are deployed from the landing-page repository, not from this one, and the fields involved belong to a different app's collection. This repository keeps a copy for a single reason: a test reads it from disk and checks that every preference in the app's schema appears in the settings allowlist. The copy is a test fixture, not a record of what is deployed.",
    ...
    sections: [
      {
        ...
        items: [
          ...
          "A winner is no longer marked between two numbers that read the same. The Mean row rounds to one decimal place for display, but chose its winner from the full-precision figures behind those. Two scenarios whose means differed in the second decimal therefore printed an identical 323.3 — with one of them bolded green and nothing on screen to explain why.",
    ...
    sections: [
      {
        title: "Changed",
        items: [
          "Milestone labels no longer sit on top of the timeline, or on each other. The Gantt chart's header packs a lot into a small space: the milestone names and dates, the timeline months, the finish date, and the Today and Target markers. Several of them were sharing the same band of pixels, so they overlapped.",
    ...
    sections: [
      {
        title: "Fixed",
        items: [
          "A sentence in the 0.67.9 notes named a button that only four of the five windows have. The 0.67.9 entry said the five new confirmation windows each have \"a red Delete button\". Four of them do. The fifth — resetting all preferences to their defaults — has a red Reset button. All five are red and all five name the action they will carry out, so only the label was wrong, but it was wrong for one window in five. The 0.67.9 entry now reads \"a red button naming the action\". Nothing in the app itself has changed.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: "Changed",
        items: [
          "Five confirmation boxes now match the rest of the app. Deleting an activity, deleting several selected activities at once, deleting a scenario, deleting a project whose stored data could not be read, and resetting all preferences to their defaults each used to raise the browser's own grey \"Are you sure?\" box. All five now ask in a window that matches the app, in both light and dark themes, with a red button naming the action and wording that says what will actually happen — including, where it is true, that Undo will bring it back.",
    ...
    sections: [
      {
        title: "Fixed",
        items: [
          "Cancel in the Edit Activity window now asks before discarding your changes. Say yes and the window closes without saving anything; say no and you are back in the window with your work intact. With nothing changed it simply closes, as before.",
          "The reason for asking is that Cancel and Save sit next to each other, and a slip is easy to miss: you can walk away believing you saved when in fact everything was thrown away, and nothing on screen would have told you.",
    ...
    sections: [
      {
        title: "Changed",
        items: [
          "A check in the release gate had been quietly skipping itself in exactly the situation releases are normally prepared in. It confirms that a project's internal notes file declares the same version number as everything else, and it skips when that file is not present — correct on the automated build server, where the file is deliberately excluded and genuinely absent.",
  ...
  },
  {
    ...
    sections: [
      {
        title: "Security — signed-in users could list other people's cloud projects",
        items: [
      ...
      {
        title: "Security — deployment response headers",
        items: [
    ...
    sections: [
      {
        title: "Changed",
        items: [
          "NO BEHAVIOUR CHANGE. Nothing in the app looks or works differently from v0.63.2. This entry records the close of a multi-day codebase-quality campaign whose visible results were already shipped, one at a time, in the releases from v0.60.0 to v0.63.2. The full record \u2014 what was measured, what was decided, and what was got wrong \u2014 is in docs/CLOSEOUT_codebase-quality-v0.63.2.md.",
    ...
    sections: [
      {
        title: "Changed",
        items: [
          "Licensing only. Nothing in the app changed — it behaves identically to 0.63.1.",
          ...
          "This is the last of the nine SPERT® Suite repositories to receive the change; the other eight shipped it on August 2.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: "Fixed",
        items: [
          "Clearing an activity's name in the edit modal could discard every other change without warning. The Save button correctly refused an empty name — an activity must have one — but nothing told you why, and the \"you have unsaved changes\" prompt was itself conditional on the form being saveable. So an empty name switched off the very guard that protects your work: dismissing the modal closed it straight away and threw out the status, estimates, constraint and notes you had also edited, with no prompt at all. The name field now says that a name is required, and dismissing a form that cannot be saved asks before discarding.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      {
        title: "Changed — the repository's changelog record",
        items: [
          "Record-keeping only. Nothing in the app changed — it schedules identically to v0.59.5.",
          "The last three releases that were listed here in the app but missing from the changelog file kept alongside the source code — v0.16.1, v0.16.3 and v0.16.4 — have now been copied across. The two records are complete and identical for the first time, covering all 217 releases back to v0.1.0.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: "Changed — the repository's changelog record",
        items: [
          "Record-keeping only. Nothing in the app changed — it schedules identically to v0.59.4.",
          "Thirty releases — v0.1.0 through v0.15.1 — have always been listed here in the app but had never been written into the changelog file kept alongside the source code. They have now been copied across word for word, so both records tell the same story back to the very first release. Three more, from the v0.16.x series, are still outstanding; they sit between existing entries rather than at the end, so they are being done separately, and they are tracked automatically in the meantime.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          "Two errors in this app\u2019s copy of the license were corrected at the same time: the heading carried the retired \"Statistical PERT\u00ae Software Suite\" name instead of \"SPERT\u00ae Suite\", and the additional terms were an older, weaker wording that left out both the ban on replacing the author\u2019s name with someone else\u2019s and the requirement that the credit appear somewhere visible in the interface. The retired name in this app is what prompted the review of all nine SPERT\u00ae Suite repositories.",
          "Nothing in the app itself changed.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      {
        title: "Security — Development-toolchain dependency updates",
        items: [
  ...
  },
  {
    ...
    sections: [
      {
        title: "Fixed — Schedule exports now include constraint columns in sequential mode",
        items: [
  ...
  },
  {
    ...
    sections: [
      {
        title: "Fixed — Connect AI session and feed corrections",
        items: [
      ...
      {
        title: "Changed — Internal restructuring of the AI batch service (no behavior change)",
        items: [
          "The AI batch service was split along its existing seams into a four-module family: the op contract, the singular handlers with their shared item-level cores, the bulk/composite/reorder handlers, and the dispatcher. Public API, op semantics, and the AI op contract are all preserved exactly; the full pre-existing test suite passes unmodified.",
        ],
      },
      {
        title: "Dependencies",
  ...
  },
  {
    ...
    sections: [
      {
        title: "Changed — Connect AI prompt now advertises the Phase 2 bulk tools",
        items: [
          "The \"Copy prompt\" text for connecting an AI assistant now lists the two new bulk tools and how to use them: scheduler_bulk_update_activities (patch names/estimates/confidence/distribution/descriptions across up to 100 activities in one call — absent fields unchanged, empty-string description clears, repeated ids apply in order) and scheduler_bulk_import (build a whole schedule — activities, milestones, assignments, dependencies — in one call, with the section order, the dependency all-or-nothing rule, and the not-found cascade spelled out). The general steering was widened from \"creating more than ~3 of anything\" to \"creating or updating more than ~3.\" Prompt text only — the tools shipped in 0.56.0 and went live server-side first, so the assistant is never told about a tool the server cannot yet handle.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    sections: [
      {
        title: "Maintenance — development dependency updates",
        items: [
          "Updated several development and testing dependencies (the lint plugin, property-testing, and browser-globals libraries) to their latest soaked minor releases. This is a tooling-only change with no effect on the app's behavior, your data, or any feature.",
        ],
      },
    ],
  },
