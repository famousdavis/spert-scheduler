...
export const GRID_COLUMNS =
  "24px 28px 1fr 60px 90px 90px 42px 42px 42px 96px 110px 106px 56px 1px 44px 20px";

/** Grid column template with constraint column (dependency mode). */
export const GRID_COLUMNS_WITH_CONSTRAINT =
  "24px 28px 1fr 60px 90px 90px 80px 42px 42px 42px 96px 110px 106px 56px 1px 44px 20px";
