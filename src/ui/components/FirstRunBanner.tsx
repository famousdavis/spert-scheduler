...
export function FirstRunBanner() {
  ...
  return (
    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4 flex items-center gap-4 no-print [overflow-anchor:none]">
